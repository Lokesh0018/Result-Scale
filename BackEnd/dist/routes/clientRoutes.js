...
exports.router.get("/dashboard/:clientId", clientController_1.getDashboard);
...
exports.router.get("/students/:clientId", clientController_1.getStudents);
exports.router.patch("/password/:email", clientController_1.updatePassword);
exports.router.put("/profile/:clientId", clientController_1.updateProfile);
